...
public class icon2 extends Fragment {
    ...
    private void init() {
        ...
        mArrayList.add(i3);
        Faxan i4 = new Faxan("芭比Uki宝贝祝大叔生日快乐", "[主持]芭比uu3号小可", "热门", "288", "635","https://momeak.oss-cn-shenzhen.aliyuncs.com/dear3.png");
        mArrayList.add(i4);
        Faxan i5 = new Faxan("芭比Uki宝贝祝大叔生日快乐", "[主持]芭比uu3号小可", "热门", "288", "635","https://momeak.oss-cn-shenzhen.aliyuncs.com/dear3.png");
        mArrayList.add(i5);
        ...
        double b = 155*are;
        layoutParamsHeight = (int) (h+5*b+60);
