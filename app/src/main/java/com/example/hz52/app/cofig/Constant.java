...
public class Constant {
    ...
    public static final String ACTION_KEY_ROOM_MODE = "房间模式";
    public static final String ACTION_KEY_ROOM_ID = "房间名称";
    public static final String ACTION_KEY_TITLE_NAME = "标题";
