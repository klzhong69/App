...
public class my_favorite extends AppCompatActivity {
    ...
    private void initData() {
        ...
        OkGo.<String>post(application.getUrl()+"/app/user/getFavoriteRoom?token="+application.getToken())
                    ...
                    public void onSuccess(com.lzy.okgo.model.Response<String> response) {
                        ...
                        if(prexiew.getCode()==0){
                            for (int i = 0; i < jsonArray.size(); i++) {
                                ...
                                Footprint i1 = new Footprint(jsonArray.get(i).getAsJsonObject().get("coverUrl").getAsString(), jsonArray.get(i).getAsJsonObject().get("ownerName").getAsString(),"", jsonArray.get(i).getAsJsonObject().get("roomName").getAsString());
                                mArrayList.add(i1);
                            }
